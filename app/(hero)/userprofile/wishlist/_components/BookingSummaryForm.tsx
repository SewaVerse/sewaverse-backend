    ...
    return (
      <div className="md:w-[300px] md:h-[500px] w-full h-auto">
        <span className="flex gap-1">
          ...
          <h1 className="text-base">Balaju, Tarakeshwor-3, Kathmandu, Bagmati Province</h1>
        </span>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="flex items-center justify-between p-4">
                <p className="text-base text-muted-foreground">Total Bookings (1 Sewa)</p>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-grow">
                      <FormControl>
                        <Input className="outline-none" placeholder="Enter Promocode" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="flex items-center justify-between p-4">
                ...
                <p className="text-xl font-semibold gradient-text">Rs.{totalAmount.toLocaleString()}</p>
              </div>
              <Button className="w-[280px] mx-2 mb-3" variant="brand" type="button">
