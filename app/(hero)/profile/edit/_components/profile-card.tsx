        ...
        <div className="flex-1">
          ...
          <div className="mt-4 grid grid-cols-3 gap-6">
            <div>
              ...
              <p className="gradient-text font-medium">{data.profession}</p>
            </div>
            <div>
          ...
          <div className="mt-4">
            ...
            <div className="mt-1">
              {data.offeredServices.map((service) => (
                <span key={service} className="gradient-text">
                  {service}
                </span>
              ))}
            </div>
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-2 mt-1">
              {data.coreSkills.map((skill) => (
                <Badge key={skill} className="bg-brand-gradient text-white">
                  {skill}
                </Badge>
              ))}
            </div>
