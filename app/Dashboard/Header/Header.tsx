      ...
      <div className="flex items-center w-full max-w-6xl justify-between">
        ...
        <div className="flex items-center flex-1 mx-5 bg-gray-100 rounded-full overflow-hidden shadow-md">
          ...
          <button className="bg-purple-600 p-2.5 flex items-center justify-center cursor-pointer">
            <Image src="/images/search.svg" alt="search" width={16} height={16} className="filter brightness-0 invert" />
          </button>
        </div>

        {/* Navigation Links */}
        <div className="flex items-center gap-5">
          <a href="#why-sewaverse" className="text-gray-800 text-sm hover:text-purple-600">
            Why Sewaverse
          </a>
          <a href="#provider" className="text-[#2E3192] text-sm hover:text-[#1a2573]">
            Become a Sewa provider
          </a>
          <a href="#" className="text-gray-800 text-sm hover:text-purple-600" onClick={handleLoginClick}>
            Login
          </a>
