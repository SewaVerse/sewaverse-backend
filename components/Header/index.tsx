...
import loginImg from "../../assets/images/loginTheme.svg";
    ...
    <header className="flex items-center justify-between px-6 py-3 shadow-md">
      <div className="flex items-center space-x-4">
        <div className="flex items-center">
          ...
          <div className="flex gap-8 p-2 border border-gray-300 box-shadow rounded-lg w-full">
            <select
              value={category}
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed top-0 right-1/2  max-w-lg bg-white p-6 shadow-lg md:rounded-lg">
            <div className="flex h-full w-full">
              <div>
                <Image src={loginImg} alt="Logo" width={500} height={700} />
              </div>
              <div>
