  ...
  return (
    <footer className="bg-gray-100 py-10">
      <div className="container mx-auto flex flex-wrap justify-between px-4">
        ...
        <div className="flex-1 max-w-xs mb-8 md:mb-0">
          <Image
          ...
          <div className="w-full sm:w-auto">
            ...
            {/* <ul className="space-y-2">
              <li className="text-gray-600">
                <Image src="/images/phone.svg" alt="Phone" width={30} height={30} />+977-2131222211</li>
              <li><a href="mailto:support@gmail.com" className="text-gray-600 hover:text-blue-800">
              <Image src="/images/emailfooter.svg" alt="Phone" width={25} height={25} />support@gmail.com</a></li>
            </ul> */}
            <ul className="space-y-2">
